...
function reflection_coefficients(ωs::Union{T,AbstractVector{T}}, psource::PlaneSource{T,Dim}, material::Material{Halfspace{T,Dim}}; kws...) where {T<:Number,Dim}
...
reflection_coefficient(ω::T, waves::Vector{EffectivePlaneWaveMode{T,Dim}}, psource::PlaneSource{T,Dim}, material::Material{Halfspace{T,Dim}}; kws...) where {T<:Number,Dim} =
...
reflection_coefficients(ωs::AbstractVector{T}, waves::Vector{EffectivePlaneWaveMode{T,Dim}}, psource::PlaneSource{T,Dim}, material::Material{Halfspace{T,Dim}}; kws...) where {T<:Number,Dim} =
