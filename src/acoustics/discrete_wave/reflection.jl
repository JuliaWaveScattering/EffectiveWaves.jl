function reflection_coefficient(ω::T, amps::DiscretePlaneWaveMode{T}, medium::Acoustic{T,2}, specie::Specie{T,2}; θin::T = 0.0, scheme::Symbol = :trapezoidal) where T <: AbstractFloat
