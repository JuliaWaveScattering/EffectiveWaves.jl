...
wavenumber_challis(ωs::AbstractArray,medium::Acoustic{T,2}, species::Species{2}; kws...) where T<:AbstractFloat = [wavenumber_challis(ω, medium, species; kws...) for ω in ωs]
...
function wavenumber_far_field_low_volumefraction(ω::Complex{T}, medium::Acoustic{T,2}, species::Species{2};
