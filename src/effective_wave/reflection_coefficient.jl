...
function reflection_coefficients(ωs::Union{T,AbstractVector{T}}, medium::PhysicalMedium{T}, species::Species{T}; kws...) where T<:Number
    ...
    Rs = map(ωs) do ω
        ...
        w_effs = [EffectivePlaneWaveMode(ω, k_eff, medium, species; kws...) for k_eff in k_effs]
...
reflection_coefficient(ω::T, waves::Vector{EffectivePlaneWaveMode{T}}, medium::PhysicalMedium{T}, species::Species{T}; kws...) where T<:Number =
...
reflection_coefficients(ωs::AbstractVector{T}, waves::Vector{EffectivePlaneWaveMode{T}}, medium::PhysicalMedium{T}, species::Species{T}; kws...) where T<:Number =
