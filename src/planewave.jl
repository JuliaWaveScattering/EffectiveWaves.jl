...
function reflection_coefficient(ω::T, medium::Medium{T}, species::Array{Specie{T}}; kws...) where T<:Number

    k_eff = wavenumber(ω, medium, species; kws...)
    return reflection_coefficient(ω, k_eff, medium, species; kws...)
end

function reflection_coefficient(ω::T, k_eff::Complex{T}, medium::Medium{T}, species::Array{Specie{T}};
...
function transmission_scattering_coefficients(ω::T, k_eff::Complex{T}, medium::Medium{T}, species::Array{Specie{T}};
            hankel_order = 3,
