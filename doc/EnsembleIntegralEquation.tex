...
\begin{multline}
 2 \nfrac {}\frac{ \ee^{-\ii x \cos \theta_\inc } }{ \cos \theta_\inc} \sum_{n=-\infty}^\infty \int_\regS
...
\begin{multline}
  \nfrac {}\ee^{-\ii x \cos \theta_\inc } \sum_{n=-\infty}^\infty
  \int_{X>0} \A n (X/k) S_{n-m}(X) dX
  d\s_2^n
  \\
  +  \nfrac {} \sum_{n=-\infty}^\infty
...
\begin{multline}
  \nfrac {}\ee^{-\ii x \cos \theta_\inc } \sum_{n=-\infty}^\infty
  \int_{X>0} \scatZ_n \A n (X/k) S_{n-m}(X) dX
  \\
  +  \nfrac {} \sum_{n=-\infty}^\infty
    \int_{\stackrel{|X-x| < k a_{12}}{X>0}} \scatZ_n \A n (X/k) (B_{n-m}(X- x,k) - S_{n-m}(X-x) )dX
    d\s_2^n
\\
+  k^2 \A m (x/k)   + k^2  \ee^{\ii x \cos \theta_\inc} \ee^{\ii m ( \pi/2 - \theta_\inc )}
   = 0, \quad \text{for} \quad x_1 >0,
