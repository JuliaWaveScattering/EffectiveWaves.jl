...
\begin{multline}
  ...
  E_{n,m}^\ell  = \frac{2 \nfrac {} Z^n}{\cos \theta_\inc} (-1)^n \ii^{-m} \ee^{\ii (m-n) \theta_\inc}
   \sum_p \ee^{-\ii n \theta_p} A_{n}^p \int_{X>\bar x} \ee^{\ii \frac{X}{k} (k_p \cos \theta_p + k \cos \theta_\inc)}
  \ee^{- \ii x^\ell\cos \theta_\inc}
   dX
   \\
   = \frac{2 k \nfrac {} Z^n }{\cos \theta_\inc} (-1)^n \ii^{-m}
    \sum_p A_{n}^p \ee^{\ii (m-n) \theta_\inc - \ii n \theta_p}
    \frac{\ii \ee^{\ii  \frac{\bar x}{k} (k_p \cos \theta_p  + k  \cos \theta_\inc) - \ii  x^\ell \cos \theta_\inc}}
...
\sum_{n=-\infty}^\infty 2 k \nfrac {} Z^n  \sum_{p}
 A_n^p  \ee^{\ii n (\theta_\inc - \theta_p)} \frac{\ee^{\ii \frac{\bar x}{k} (k_p \cos \theta_p - k \cos \theta)}}{k_p \cos \theta_p - k \cos \theta}
  = \ii k^2 \cos \theta \\
  +2\nfrac {} \sum_{n=-\infty}^\infty (-\ii)^{n-1} \ee^{\ii n \theta_\inc}
     \int_{0}^{{\bar x}} \A n(X) Z^n  \ee^{-\ii X \cos \theta_\inc}  d X ,
\end{multline}
